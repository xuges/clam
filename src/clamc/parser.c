...
Statement _Parser_statement(Parser* p)
{
	...
	default:
		...
		case TOKEN_VALUE_BITAND_ASSIGN:
			stat.type = STATEMENT_TYPE_BITAND_ASSIGN;
			Lexer_next(p->lex);
			stat.assign.leftExpr = stat.expr;
			stat.assign.rightExpr = _Parser_expression(p);
			break;
		...
		case TOKEN_VALUE_BITOR_ASSIGN:
			stat.type = STATEMENT_TYPE_BITOR_ASSIGN;
			Lexer_next(p->lex);
			stat.assign.leftExpr = stat.expr;
			stat.assign.rightExpr = _Parser_expression(p);
			break;
		...
		case TOKEN_VALUE_LSHIFT_ASSIGN:
			stat.type = STATEMENT_TYPE_LSHIFT_ASSIGN;
			Lexer_next(p->lex);
			stat.assign.leftExpr = stat.expr;
			stat.assign.rightExpr = _Parser_expression(p);
			break;
		
		case TOKEN_VALUE_RSHIFT_ASSIGN:
			stat.type = STATEMENT_TYPE_RSHIFT_ASSIGN;
			Lexer_next(p->lex);
			stat.assign.leftExpr = stat.expr;
			stat.assign.rightExpr = _Parser_expression(p);
			break;
