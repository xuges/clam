...
static TestCase tests[] =
{
	...
	TEST(test_parser, "and_expression",       "bool a = 1 + 1 == 2 && 2 + 2 == 4 && 3 * 3 == 9 && 2 * 3 != 5;")
	TEST(test_parser, "or_expression",        "bool a = 1 + 1 == 2 || 2 + 2 == 3 || 3 * 3 != 9;")
	...
	TEST(test_parser, "lshift_expression",    "int a = 1 << 1;")
	TEST(test_parser, "rshift_expression",    "int a = 2 >> 1;")
	...
	TEST(test_executor, "and_expression",       "bool a = true; bool b = true; export int main() { if (a && b) return 1; return 0; }")
	TEST(test_executor, "or_expression",        "bool a = 1 + 1 == 2 || 2 + 2 == 3 || 3 * 3 != 9; export int main() { if (a) return 1; return 0; }")
	...
	TEST(test_executor, "xor_assign_statement",    "int a = 3; export int main() { a ^= 2; return a; }")
	TEST(test_executor, "lshift_assign_statement", "int a = 1; export int main() { a <<= 1; return a; }")
	TEST(test_executor, "rshift_assign_statement", "int a = 2; export int main() { a >>= 1; return a; }")
	...
	TEST(test_generator, "operation5",          "int a = (1 + 1) * 2; int b = (1 + 1) * (2 + 2); export int main() { return b; }")
	...
	TEST(test_generator, "ne_expression",         "bool a = 1 != 2; bool b = 1 + 1 != 2; bool c = 1 + 1 != 2 * 2; export int main() { if (!b) return 1; return 0; }")
	TEST(test_generator, "equals_expression",     "bool a = 1 + 1 == 2; export int main() { if (a) return 1; return 0; }")
	...
	TEST(test_generator, "rshift_assign_statement", "int a = 2; export int main() { a >>= 1; return a; }")
